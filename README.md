# 🐳 WhaleBot.ai 智能鲸鱼小车 (ESP32-S3 AI Robot)
...
为了让初学者免去元器件采购发货慢、型号买错的烦恼，我们提供了**一站式全套件**（包含 3D 打印外壳、PCB 成品/半成品、电机、电池及所有电子料）。

👉 **[点击购买 WhaleBot 官方套件](请填入淘宝/微店链接)**
...
<img src="docs/接线图（PCB上元件焊接图和硬件安装）/你的效果图.jpg" alt="WhaleBot实物图" width="600">
*(请替换为你的项目实物图)*
